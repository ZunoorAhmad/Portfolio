      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none text-muted mb-12 leading-relaxed">
            <p>
              I started my journey into web development driven by a simple belief: technology should make people's lives easier. At Dev Blends, I've had the privilege of building applications that impact thousands of users daily, from education management systems to real-time video collaboration tools.
            </p>
            <p>
